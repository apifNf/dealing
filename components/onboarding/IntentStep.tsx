          ...
          <div className="relative flex flex-col gap-6">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-textMuted">
                Ubah aset digital Anda &mdash; konten, website, atau SaaS &mdash; menjadi likuiditas dengan
                pembeli yang sudah terverifikasi.
              </p>
            </div>
          </div>
        </button>
        ...
        >
          ...
          <div className="relative flex flex-col gap-6">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-textMuted">
                Temukan deal flow eksklusif yang sesuai dengan budget dan kategori bisnis yang Anda minati.
              </p>
            </div>
          </div>
        </Link>
