  ...
  return (
    <div className="relative">
      <select
        ref={ref}
        className={`
          w-full appearance-none rounded-2xl bg-white/[0.02] border px-4 py-3 pr-10 text-sm text-textMain
          backdrop-blur-2xl transition-all duration-300 outline-none cursor-pointer
